    ...
    <div class="d2-layout-header-aside-content" flex="dir:top">
      ...
      <div
        ...
        <div class="logo-group" :style="{width: asideCollapse ? asideWidthCollapse : asideWidth}" flex-box="0">
          <img v-if="asideCollapse" :src="`${$baseUrl}static/theme/${themeActiveSetting.name}/logo/icon-only.png`">
          <img v-else :src="`${$baseUrl}static/theme/${themeActiveSetting.name}/logo/all.png`">
        </div>
